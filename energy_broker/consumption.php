...
try {
    ...
    $totalEnergyQuery = "SELECT SUM(energy_consumed) AS total_energy FROM consumption GROUP BY supplier_id";
    ...
    <div class="dashboard-container">
        ...
        <div class="kpi-cards">
            ...
            <?php foreach ($customersPerSupplier as $supplier) : ?>
                <div class="card">
                    <h4>Supplier ID: <?php echo htmlspecialchars($supplier['supplier_id']); ?></h4>
                    <p>Count: <?php echo number_format($supplier['no_of_customers']); ?> customers</p>
                </div>
            <?php endforeach; ?>
        </div>
